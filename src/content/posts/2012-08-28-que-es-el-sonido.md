...
El sonido es una vibración, una onda, para ser más exacta se le clasifica como una [onda mecánica](http://www.slideshare.net/orckas/ondas-mecanicas). Su principal característica es que necesita de un medio material para propagarse. ¿Qué quiero decir? Por ejemplo en el espacio exterior en que, para efectos prácticos no hay materia, no se escucha sonido alguno. Ya sé que con eso arruino buena parte de las películas con batallas intergalácticas, así que solo por emoción dela Guerra de las Galaxias,  de Viaje a las Estrellas y hasta de Futurama les permitiremos ruidosas explosiones, pero rigurosamente sin materia para propagarse no hay sonido.
